...
--
-- Host: localhost:3306
-- Generation Time: Feb 02, 2024 at 12:37 AM
...
(5, '2024_02_02_001449_create_companies_table', 1),
(6, '2024_02_02_001449_create_locations_table', 1),
(7, '2024_02_02_001450_create_assets_table', 1),
(8, '2024_02_02_001450_create_employees_table', 1),
(9, '2024_02_02_001450_create_managers_table', 1),
(10, '2024_02_02_001451_create_company_groups_table', 1),
(11, '2024_02_02_001451_create_people_table', 1);
...
ALTER TABLE `company_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `company_groups_company_id_foreign` (`company_id`),
  ADD KEY `company_groups_parent_id_foreign` (`parent_id`);
...
--
ALTER TABLE `company_groups`
  ADD CONSTRAINT `company_groups_company_id_foreign` FOREIGN KEY (`company_id`) REFERENCES `companies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `company_groups_parent_id_foreign` FOREIGN KEY (`parent_id`) REFERENCES `company_groups` (`id`) ON DELETE CASCADE;
